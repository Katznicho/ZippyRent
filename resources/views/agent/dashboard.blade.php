        ...
        <div class="bg-white shadow-sm border-b">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Agent Dashboard</h1>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-200 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <a href="{{ route('agent.properties.create') }}" class="flex items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                    ...
                    <a href="{{ route('agent.properties') }}" class="flex items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                ...
                <div class="p-6">
                            ...
                            @foreach($stats['recent_properties'] as $property)
                                <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <a href="{{ route('agent.properties.edit', $property) }}" class="text-blue-600 hover:text-blue-800">
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <a href="{{ route('agent.properties.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-medium transition-colors">
