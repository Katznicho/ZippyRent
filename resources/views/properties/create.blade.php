        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="bg-white rounded-lg shadow-sm">
                <div class="px-6 py-4 border-b border-gray-200">
                    ...
                    <p class="text-gray-600 mt-1">Create a new property listing with all the details</p>
                </div>
                
                <form method="POST" action="{{ route('admin.properties.store') }}" enctype="multipart/form-data" class="p-6 space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="text" id="title" name="title" required 
                               ...
                               placeholder="e.g., Modern 2-Bedroom Apartment in Kololo" value="{{ old('title') }}">
                        @error('title')
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4" required 
                                  ...
                                  placeholder="Describe the property features, amenities, and highlights...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" id="price" name="price" step="0.01" min="0" required 
                               ...
                               placeholder="e.g., 1200000" value="{{ old('price') }}">
                        @error('price')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="location" name="location" required 
                               ...
                               placeholder="e.g., Kololo, Kampala" value="{{ old('location') }}">
                        @error('location')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" id="bedrooms" name="bedrooms" min="0" required 
                                   ...
                                   placeholder="2" value="{{ old('bedrooms') }}">
                            @error('bedrooms')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" id="bathrooms" name="bathrooms" min="0" required 
                                   ...
                                   placeholder="2" value="{{ old('bathrooms') }}">
                            @error('bathrooms')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" id="area" name="area" min="0" required 
                                   ...
                                   placeholder="1200" value="{{ old('area') }}">
                            @error('area')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-sm text-gray-500">
                            ...
                            Upload multiple images (JPEG, PNG, GIF) - Max 2MB each
                        </p>
                        @error('images')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
