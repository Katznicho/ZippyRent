            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-8">
                    <div class="text-center">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mb-4">Premium Properties</h3>
                        <p class="text-gray-600">Handpicked properties that meet our high standards for quality and comfort.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Trust & Transparency</h3>
                    <p class="text-gray-600">We believe in honest communication and transparent processes. No hidden fees, no surprises.</p>
                </div>
                ...
                <div class="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Speed & Efficiency</h3>
                    <p class="text-gray-600">We understand that finding a home is urgent. Our streamlined process gets you settled quickly.</p>
                </div>
                ...
                <div class="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                    ...
                    <p class="text-gray-600">Your satisfaction is our priority. We provide ongoing support throughout your rental experience.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-600">Advanced filtering and search tools to find properties that match your exact needs.</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-600">All properties are verified and inspected to ensure quality and accuracy.</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-600">Round-the-clock customer support to help you whenever you need assistance.</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Fair Pricing</h3>
