<x-app-layout title="About Us - ZippyRent" description="Learn about ZippyRent, Uganda's premier property rental platform. Our mission, values, and commitment to providing exceptional property management services.">
    <div class="bg-gray-50 min-h-screen">
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
                <div class="text-center">
                    ...
                    <h1 class="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 leading-tight">
                        Uganda's Premier
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-yellow-400">Property Platform</span>
                    </h1>
                    <p class="text-xl sm:text-2xl mb-8 text-blue-100 leading-relaxed max-w-4xl mx-auto">
                        We're revolutionizing the property rental experience in Uganda with innovative technology, 
                        professional service, and unwavering commitment to our clients' success.
                    </p>
                </div>
            </div>
        </section>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="bg-white rounded-2xl shadow-xl p-8 lg:p-12">
                        ...
                        <p class="text-lg text-gray-600 leading-relaxed">
                            To simplify and enhance the property rental experience in Uganda by connecting tenants with 
                            quality properties through innovative technology, professional service, and transparent processes. 
                            We believe everyone deserves access to safe, comfortable, and affordable housing.
                        </p>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-xl p-8 lg:p-12">
                        ...
                        <p class="text-lg text-gray-600 leading-relaxed">
                            To become Uganda's most trusted and innovative property rental platform, setting the standard 
                            for excellence in property management, customer service, and technological innovation. We envision 
                            a future where finding the perfect home is effortless and enjoyable.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    ...
                    <p class="text-lg text-gray-600 max-w-3xl mx-auto">
                        Founded with a passion for transforming Uganda's property rental landscape
                    </p>
                </div>

                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div>
                        <h3 class="text-2xl font-bold text-gray-900 mb-6">From Vision to Reality</h3>
                        <div class="space-y-6">
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-900 mb-2">Innovation First</h4>
                                    <p class="text-gray-600">We developed cutting-edge technology to streamline the rental process, making it faster, more transparent, and more reliable.</p>
                                </div>
                            </div>
                            <div class="flex items-start space-x-4">
                                <div class="flex-shrink-0 w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center">
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-900 mb-2">Growing Impact</h4>
                                    <p class="text-gray-600">Today, we're proud to serve thousands of clients across Uganda, helping them find their perfect homes with confidence and ease.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-8">
                            <div class="grid grid-cols-2 gap-6">
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="text-sm text-gray-600">Partner Agents</div>
                                </div>
                                <div class="text-center">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow">
                        ...
                        <p class="text-gray-600">We operate with complete transparency and honesty in all our dealings, building trust through consistent actions.</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow">
                        ...
                        <p class="text-gray-600">We continuously embrace new technologies and methods to improve the property rental experience.</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow">
                        ...
                        <p class="text-gray-600">We strive for the highest standards in everything we do, from customer service to property management.</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow">
                        ...
                        <p class="text-gray-600">We're committed to building stronger communities by connecting people with their ideal homes and neighborhoods.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-16 sm:py-24 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    ...
                    <p class="text-lg text-gray-600 max-w-3xl mx-auto">
                        Dedicated professionals committed to making your property rental experience exceptional
                    </p>
                </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                        <div class="h-64 bg-gradient-to-br from-blue-400 to-purple-500 flex items-center justify-center">
                            <div class="text-center text-white">
                                ...
                                <h3 class="text-xl font-bold">Sarah Kigozi</h3>
                                <p class="text-blue-100">CEO & Founder</p>
                            </div>
                        </div>
                        <div class="p-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                        <div class="h-64 bg-gradient-to-br from-green-400 to-blue-500 flex items-center justify-center">
                            <div class="text-center text-white">
                                ...
                                <h3 class="text-xl font-bold">Michael Ssemakula</h3>
                                <p class="text-green-100">Head of Technology</p>
                            </div>
                        </div>
                        <div class="p-6">
                            <p class="text-gray-600 text-sm leading-relaxed">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                        <div class="h-64 bg-gradient-to-br from-orange-400 to-red-500 flex items-center justify-center">
                            <div class="text-center text-white">
                                ...
                                <h3 class="text-xl font-bold">Grace Nakamya</h3>
                                <p class="text-orange-100">Customer Success Manager</p>
                            </div>
                        </div>
                        <div class="p-6">
                            <p class="text-gray-600 text-sm leading-relaxed">
                                Grace ensures every client receives exceptional service and finds their perfect property match.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <!-- CTA Section -->
        <section class="py-16 sm:py-24 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href="{{ route('contact') }}" class="border-2 border-white text-white px-8 py-4 rounded-xl font-semibold hover:bg-white hover:text-blue-600 transition-colors">
                        Contact Us
                    </a>
                </div>
            </div>
