            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
                <div class="text-center">
                    ...
                    <h1 class="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 leading-tight">
                        We're Here to
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-yellow-400">Help You</span>
                    </h1>
                    <p class="text-xl sm:text-2xl mb-8 text-blue-100 leading-relaxed max-w-4xl mx-auto">
                        Have questions about our properties? Need assistance with your rental search? 
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow">
                        ...
                        <a href="tel:+256759983853" class="text-green-600 font-semibold hover:text-green-700">
                            +256 759 983 853
                        </a>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow">
                        ...
                        <p class="text-gray-600 mb-4">Quick messaging support</p>
                        <a href="https://wa.me/256759983853" target="_blank" class="text-green-600 font-semibold hover:text-green-700">
                            Chat with us
                        </a>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow">
                        ...
                        <p class="text-gray-600 mb-4">Monday - Friday</p>
                        <p class="text-orange-600 font-semibold">8:00 AM - 6:00 PM</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div>
                        ...
                        <form action="{{ route('contact.submit') }}" method="POST" class="space-y-6">
                            ...
                            <button type="submit" class="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-8 py-4 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                    ...
                    <div class="space-y-8">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600">Plot 123, Kampala Road<br>Kampala Central, Uganda</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600">+256 759 983 853</p>
                                    </div>
                                </div>
                        ...
                        <div class="bg-white rounded-2xl shadow-lg p-8">
                            ...
                            <div class="space-y-4">
                                <a href="{{ route('properties.search') }}" class="flex items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                                    <svg class="w-6 h-6 text-blue-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                                    </svg>
                                    <div>
                                        <h4 class="font-semibold text-gray-900">Browse Properties</h4>
                                        <p class="text-sm text-gray-600">Find your perfect home</p>
                                    </div>
                                </a>
                                
                                <a href="{{ route('properties.index') }}" class="flex items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                                    <svg class="w-6 h-6 text-green-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                                    </svg>
                                    <div>
                                        <h4 class="font-semibold text-gray-900">List Your Property</h4>
                                        <p class="text-sm text-gray-600">Join our network</p>
                                    </div>
                                </a>
                                
                                <a href="https://wa.me/256759983853" target="_blank" class="flex items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600">Get instant help</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div class="space-y-6">
                        <div class="bg-white rounded-xl shadow-sm p-6">
                            <h3 class="text-lg font-semibold text-gray-900 mb-3">How do I search for properties?</h3>
                            <p class="text-gray-600">Use our advanced search filters on the homepage or visit our search page to find properties by location, type, price range, and other criteria.</p>
                        </div>
                        
                        <div class="bg-white rounded-xl shadow-sm p-6">
                            <h3 class="text-lg font-semibold text-gray-900 mb-3">What is the touring fee?</h3>
                            <p class="text-gray-600">The UGX 50,000 touring fee gives you access to premium property viewing experiences with guided tours and professional assistance.</p>
                        </div>
                        
                        <div class="bg-white rounded-xl shadow-sm p-6">
                            <h3 class="text-lg font-semibold text-gray-900 mb-3">How can I list my property?</h3>
                            <p class="text-gray-600">Property owners can register an account and list their properties through our property management portal. Contact us for more information.</p>
                        </div>
                    </div>
                    
                    <div class="space-y-6">
                        <div class="bg-white rounded-xl shadow-sm p-6">
                            <h3 class="text-lg font-semibold text-gray-900 mb-3">Do you offer virtual tours?</h3>
                            <p class="text-gray-600">Yes! Many of our properties feature video tours that you can watch directly on our platform or on YouTube.</p>
                        </div>
                        
                        <div class="bg-white rounded-xl shadow-sm p-6">
                            <h3 class="text-lg font-semibold text-gray-900 mb-3">What areas do you cover?</h3>
                            <p class="text-gray-600">We cover major areas in Uganda including Kampala, Entebbe, Jinja, and surrounding regions. Contact us to confirm coverage in your area.</p>
                        </div>
                        
                        <div class="bg-white rounded-xl shadow-sm p-6">
                            <h3 class="text-lg font-semibold text-gray-900 mb-3">How quickly do you respond?</h3>
                            <p class="text-gray-600">We aim to respond to all inquiries within 24 hours. For urgent matters, WhatsApp or phone calls are the fastest way to reach us.</p>
                        </div>
                    </div>
                </div>
            </div>
